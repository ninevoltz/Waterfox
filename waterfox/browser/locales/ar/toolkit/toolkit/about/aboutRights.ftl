...
rights-intro-point-1 = يُتاح لك { -brand-short-name } وفق بنود <a data-l10n-name="mozilla-public-license-link">رخصة BrowserWorks العامة</a>. يعني هذا أنك تستطيع استخدام { -brand-short-name } ونسخه وتوزيعه إلى الآخرين.  تستطيع أيضًا تعديل كود { -brand-short-name } المصدري كما تشاء لموافقة احتياجاتك. كما تعطيك رخصة موزيلا العامة الحق في توزيع نسخك المعدلة.
rights-intro-point-2 = لا يعطيك هذا أي حقوق أو تراخيص للعلامات التجارية لمؤسسة BrowserWorks أو أي طرف آخر، متضمنًا على سبيل المثال لا الحصر اسم Waterfox وشعاره. يمكنك الاطلاع على مزيد من المعلومات عن العلامات التجارية <a data-l10n-name="mozilla-trademarks-link">هنا</a>.
