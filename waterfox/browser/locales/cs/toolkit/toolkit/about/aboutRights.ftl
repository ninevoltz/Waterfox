...
rights-intro-point-1 =
    ...
    } za podmínek stanovených licencí <a data-l10n-name="mozilla-public-license-link">BrowserWorks Public License</a> (MPL). Ta vám umožňuje aplikaci { -brand-short-name } používat, kopírovat a šířit. Pokud potřebujete, můžete také pozměnit zdrojový kód aplikace { -brand-short-name } podle vašich potřeb. MPL vám dává také právo šířit vámi pozměněné verze.
rights-intro-point-2 = Nejsou vám však podstoupena žádná práva ani licence k ochranným známkám BrowserWorks, či třetích stran, a to zejména k logu a názvu Waterfox. Podrobnější informace o ochranných známkách jsou dostupné <a data-l10n-name="mozilla-trademarks-link">zde</a>.
