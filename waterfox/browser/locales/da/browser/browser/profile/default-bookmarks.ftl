...
default-bookmarks-firefox-customize = Tilpas Waterfox
...
default-bookmarks-nightly-heading = Om Waterfox Nightly

# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Blog om Waterfox Nightly
