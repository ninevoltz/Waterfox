...
protocolhandler-mailto-os-handler-notificationbox = Tillad altid { -brand-short-name } at åbne links, der sender mail?
protocolhandler-mailto-os-handler-yes-confirm = { -brand-short-name } er nu dit standard-program til at åbne links, der sender mail.
protocolhandler-mailto-os-handler-yes-button = Indstil som standard
protocolhandler-mailto-os-handler-no-button = Ikke nu
...
protocolhandler-mailto-handler-yes-button = Indstil som standard
protocolhandler-mailto-handler-no-button = Ikke nu
