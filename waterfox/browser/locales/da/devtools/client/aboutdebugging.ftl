...
about-debugging-browser-version-too-old-fennec = Denne version af Waterfox kan ikke bruges til at debugge Waterfox til Android (68). Vi anbefaler, at du installerer Waterfox Nightly til Android for at kunne teste. <a>Læs mere</a>
