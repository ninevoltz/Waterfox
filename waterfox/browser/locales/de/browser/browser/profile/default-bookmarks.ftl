...
default-bookmarks-firefox-customize = Waterfox anpassen
...
default-bookmarks-nightly-heading = Ressourcen zu Waterfox Nightly

# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Blog zu Waterfox Nightly (englisch)
...
default-bookmarks-planet = Planet BrowserWorks (englisch)
