...
protocolhandler-mailto-os-handler-notificationbox = Immer { -brand-short-name } verwenden, um Links zum Senden von E-Mails zu öffnen?
protocolhandler-mailto-os-handler-yes-confirm = { -brand-short-name } ist jetzt Ihre Standardanwendung zum Öffnen von Links, die E-Mails senden.
protocolhandler-mailto-os-handler-yes-button = Als Standard festlegen
protocolhandler-mailto-os-handler-no-button = Nicht jetzt
...
protocolhandler-mailto-handler-yes-button = Als Standard festlegen
protocolhandler-mailto-handler-no-button = Nicht jetzt
