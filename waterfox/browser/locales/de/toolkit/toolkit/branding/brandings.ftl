...
-focus-brand-name = Waterfox Klar
...
-fakespot-brand-full-name = Fakespot von BrowserWorks
# “Suggest” can be localized, “Waterfox” must be treated as a brand
# and kept in English.
-firefox-suggest-brand-name = Waterfox-Vorschläge
# ”Home" can be localized, “Waterfox” must be treated as a brand
# and kept in English.
-firefox-home-brand-name = Waterfox-Startseite
