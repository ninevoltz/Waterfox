...
desktop-entry-x-gnome-full-name = Πρόγραμμα περιήγησης { -brand-shortcut-name }
...
desktop-action-new-window-name = Νέο παράθυρο
desktop-action-new-private-window-name = Νέο ιδιωτικό παράθυρο
desktop-action-open-profile-manager = Άνοιγμα Διαχείρισης προφίλ
