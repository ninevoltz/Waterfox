...
protocolhandler-mailto-os-handler-notificationbox = Να χρησιμοποιείται πάντα το { -brand-short-name } για το άνοιγμα συνδέσμων που στέλνουν email;
protocolhandler-mailto-os-handler-yes-confirm = Το { -brand-short-name } είναι πλέον η προεπιλεγμένη εφαρμογή σας για το άνοιγμα συνδέσμων που στέλνουν email.
protocolhandler-mailto-os-handler-yes-button = Ορισμός ως προεπιλογή
protocolhandler-mailto-os-handler-no-button = Όχι τώρα
...
protocolhandler-mailto-handler-yes-button = Ορισμός ως προεπιλογή
protocolhandler-mailto-handler-no-button = Όχι τώρα
