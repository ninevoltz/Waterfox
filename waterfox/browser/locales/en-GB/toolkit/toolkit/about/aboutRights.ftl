...
rights-intro-point-1 = { -brand-short-name } is made available to you under the terms of the <a data-l10n-name="mozilla-public-license-link">BrowserWorks Public Licence</a>. This means you may use, copy and distribute { -brand-short-name } to others.  You are also welcome to modify the source code of { -brand-short-name } as you want to meet your needs. The BrowserWorks Public Licence also gives you the right to distribute your modified versions.
rights-intro-point-2 = You are not granted any trademark rights or licences to the trademarks of the BrowserWorks or any party, including without limitation the Waterfox name or logo. Additional information on trademarks may be found <a data-l10n-name="mozilla-trademarks-link">here</a>.
