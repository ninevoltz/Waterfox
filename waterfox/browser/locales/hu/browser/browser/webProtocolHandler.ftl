...
protocolhandler-mailto-os-handler-notificationbox = Mindig a { -brand-short-name }ot használja a levélküldési hivatkozások megnyitásához?
...
protocolhandler-mailto-handler-yes-button = Beállítás alapértelmezettként
protocolhandler-mailto-handler-no-button = Most nem
