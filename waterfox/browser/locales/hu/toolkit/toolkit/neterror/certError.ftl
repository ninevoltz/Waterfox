...
cert-error-mitm-mozilla = A { -brand-short-name } mögött a nonprofit BrowserWorks áll, amely egy teljesen nyílt tanúsítványtárolót kezel. A CA tároló biztosítja, hogy a tanúsítványkibocsátók kövessék a felhasználói biztonságra vonatkozó legjobb gyakorlatokat.

cert-error-mitm-connection = A { -brand-short-name } a BrowserWorks CA tároló használatával ellenőrzi, hogy a kapcsolat biztonságos-e, és nem a felhasználó operációs rendszere által biztosított tanúsítványokkal. Tehát ha egy víruskereső program vagy egy hálózat elfogja a CA által kibocsátott biztonsági tanúsítványt, és az nincs a BrowserWorks CA tárolóban, akkor a kapcsolat nem biztonságosként lesz kezelve.
