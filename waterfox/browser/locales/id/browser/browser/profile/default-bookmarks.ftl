...
default-bookmarks-firefox-customize = Ubahsuai Waterfox
...
default-bookmarks-nightly-heading = Sumber Daya Waterfox Nightly

# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Blog Waterfox Nightly

# Nightly builds only, link title for https://bugzilla.mozilla.org/
default-bookmarks-bugzilla = Pelacak Bug BrowserWorks
