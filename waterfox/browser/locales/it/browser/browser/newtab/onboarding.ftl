...
onboarding-gratitude-security-and-privacy-subtitle = Grazie per aver scelto di utilizzare { -brand-short-name }, il browser supportato da BrowserWorks. Con il tuo supporto, lavoriamo per rendere Internet più sicuro e accessibile per tutti.
