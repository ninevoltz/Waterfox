...
default-bookmarks-getting-started = Waterfox を使いこなそう
...
default-bookmarks-firefox-customize = Waterfox をカスタマイズしてみよう

# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = BrowserWorks のコミュニティ

# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = BrowserWorks について

# Waterfox Nightly links folder name
default-bookmarks-nightly-heading = Waterfox Nightly Resources

# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Waterfox Nightly blog
