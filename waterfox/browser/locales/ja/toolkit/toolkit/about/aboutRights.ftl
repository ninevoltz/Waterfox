...
rights-intro-point-1 = { -brand-short-name } は <a data-l10n-name="mozilla-public-license-link">BrowserWorks Public License</a> の条項下で提供されます。これにより、あなたは { -brand-short-name } を使用、複製、配布することができます。あなたはまた、{ -brand-short-name } のソースコードを必要に応じて修正することもできます。BrowserWorks Public License では、あなたが修正したバージョンを配布することも認めています。
rights-intro-point-2 = BrowserWorks とその関係団体の商標およびロゴについては、Waterfox の製品名およびロゴを含めこれに限定されず、何らの権利もあなたに与えるものではありません。商標について詳しくは <a data-l10n-name="mozilla-trademarks-link">BrowserWorks 商標ポリシー</a> をご確認ください。
