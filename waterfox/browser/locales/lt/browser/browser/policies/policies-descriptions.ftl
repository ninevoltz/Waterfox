...
policy-DisableWaterfoxAccounts = Išjungti „{ -fxaccount-brand-name }“ paremtas paslaugas, įskaitant „Sync“.

# Waterfox Screenshots is the name of the feature, and should not be translated.
policy-DisableWaterfoxScreenshots = Išjungti „Waterfox“ ekrano nuotraukų funkcionalumą.

policy-DisableWaterfoxStudies = Neleisti „{ -brand-short-name }“ vykdyti tyrimų.
