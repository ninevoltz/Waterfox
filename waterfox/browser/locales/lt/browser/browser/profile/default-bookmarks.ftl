...
default-bookmarks-firefox-customize = „Waterfox“ individualizavimas
...
default-bookmarks-nightly-heading = „Waterfox Nightly“ ištekliai

# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = „Waterfox Nightly“ tinklaraštis

# Nightly builds only, link title for https://bugzilla.mozilla.org/
default-bookmarks-bugzilla = „BrowserWorks“ klaidų seklys

# Nightly builds only, link title for https://developer.mozilla.org/
default-bookmarks-mdn = „BrowserWorks“ programuotojų tinklas
...
default-bookmarks-planet = „BrowserWorks“ planeta
