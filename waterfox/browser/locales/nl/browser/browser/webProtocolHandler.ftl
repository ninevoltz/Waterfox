...
protocolhandler-mailto-os-handler-notificationbox = { -brand-short-name } altijd gebruiken voor het openen van koppelingen die e-mail verzenden?
protocolhandler-mailto-os-handler-yes-confirm = { -brand-short-name } is nu uw standaardtoepassing voor het openen van koppelingen die e-mail verzenden.
protocolhandler-mailto-os-handler-yes-button = Instellen als standaard
protocolhandler-mailto-os-handler-no-button = Niet nu
...
protocolhandler-mailto-handler-yes-button = Instellen als standaard
protocolhandler-mailto-handler-no-button = Niet nu
