...
cert-error-mitm-mozilla = { -brand-short-name } wordt gesteund door de non-profitorganisatie BrowserWorks, die een volledig open archief voor certificaatautoriteiten (CA) beheert. Het CA-archief helpt te verzekeren dat certificaatautoriteiten de beste procedures voor gebruikersbeveiliging volgen.

cert-error-mitm-connection = { -brand-short-name } gebruikt het CA-archief van BrowserWorks om te verifiëren dat een verbinding is beveiligd in plaats van certificaten die door het besturingssysteem van de gebruiker worden geleverd. Als een antivirusprogramma of een netwerk dus een verbinding onderschept met een door een CA uitgegeven beveiligingscertificaat dat zich niet in het CA-archief van BrowserWorks bevindt, wordt de verbinding als onveilig beschouwd.
