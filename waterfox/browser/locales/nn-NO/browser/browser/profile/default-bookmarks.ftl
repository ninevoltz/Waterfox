...
default-bookmarks-firefox-customize = Tilpass Waterfox
...
default-bookmarks-nightly-heading = Waterfox Nightly-resursar

# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Waterfox Nightly-blogg

# Nightly builds only, link title for https://bugzilla.mozilla.org/
default-bookmarks-bugzilla = BrowserWorks Bug Tracker

# Nightly builds only, link title for https://developer.mozilla.org/
default-bookmarks-mdn = BrowserWorkss utviklarnettverk
...
default-bookmarks-planet = Planeten BrowserWorks
