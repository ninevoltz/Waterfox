...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Enable USB Debugging in Waterfox on the Android device.
...
about-debugging-browser-version-too-old-fennec = This version of Waterfox cannot debug Waterfox for Android (68). We recommend installing Waterfox for Android Nightly on your phone for testing. <a>More details</a>
...
about-debugging-browser-version-too-recent = The connected browser is more recent ({ $runtimeVersion }, buildID { $runtimeID }) than your { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). This is an unsupported setup and may cause DevTools to fail. Please update Waterfox. <a>Troubleshooting</a>
