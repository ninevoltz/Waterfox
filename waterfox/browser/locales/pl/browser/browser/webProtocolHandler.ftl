...
protocolhandler-mailto-os-handler-notificationbox = Czy zawsze używać { -brand-short-name(case: "acc") } do otwierania odnośników wysyłających wiadomość e-mail?
protocolhandler-mailto-os-handler-yes-confirm = { -brand-short-name } jest teraz domyślną aplikacją do otwierania odnośników wysyłających wiadomość e-mail.
protocolhandler-mailto-os-handler-yes-button = Ustaw jako domyślną
protocolhandler-mailto-os-handler-no-button = Nie teraz
...
protocolhandler-mailto-handler-yes-button = Ustaw jako domyślny
protocolhandler-mailto-handler-no-button = Nie teraz
