...
default-bookmarks-firefox-customize = Personalizar o Waterfox
...
default-bookmarks-nightly-heading = Recursos do Waterfox Nightly

# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Blog do Waterfox Nightly

# Nightly builds only, link title for https://bugzilla.mozilla.org/
default-bookmarks-bugzilla = Acompanhador de bugs da BrowserWorks
