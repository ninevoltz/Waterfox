...
policy-DisableWaterfoxAccounts1 = Desativar os serviços baseados na conta, incluindo a sincronização.
...
policy-WaterfoxHome2 = Configurar o { -firefox-home-brand-name }.
