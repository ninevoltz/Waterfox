...
rights-intro-point-1 = O { -brand-short-name } é disponibilizado nos termos da <a data-l10n-name="mozilla-public-license-link">BrowserWorks Public License</a>. Isto significa que pode utilizar, copiar e distribuir o { -brand-short-name } para outras pessoas.  Também pode modificar o código fonte do { -brand-short-name } conforme as suas necessidades. A BrowserWorks Public License também lhe dá o direito de distribuir as suas versões modificadas.
rights-intro-point-2 =
    Não lhe são concedidos quaisquer direitos de marcas registadas ou licenças das marcas registadas da
    Fundação BrowserWorks ou qualquer outra parte incluindo, sem limitações, o nome ou logótipo do Waterfox.
