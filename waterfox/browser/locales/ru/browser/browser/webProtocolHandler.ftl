...
protocolhandler-mailto-os-handler-notificationbox = Вы всегда используете { -brand-short-name } для открытия ссылок, по которым отправляются письма?
...
protocolhandler-mailto-handler-yes-button = Установить по умолчанию
protocolhandler-mailto-handler-no-button = Не сейчас
