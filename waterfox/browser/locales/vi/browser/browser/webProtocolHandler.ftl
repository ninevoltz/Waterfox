...
protocolhandler-mailto-os-handler-notificationbox = Luôn sử dụng { -brand-short-name } để mở các liên kết gửi email?
...
protocolhandler-mailto-handler-yes-button = Đặt làm mặc định
protocolhandler-mailto-handler-no-button = Không phải bây giờ
