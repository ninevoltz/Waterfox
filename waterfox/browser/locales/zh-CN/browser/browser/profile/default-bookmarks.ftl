...
default-bookmarks-firefox-customize = 定制 Waterfox
...
default-bookmarks-nightly-heading = Waterfox Nightly 资源

# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Waterfox Nightly 博客

# Nightly builds only, link title for https://bugzilla.mozilla.org/
default-bookmarks-bugzilla = BrowserWorks 缺陷跟踪网站

# Nightly builds only, link title for https://developer.mozilla.org/
default-bookmarks-mdn = BrowserWorks 开发者网络
