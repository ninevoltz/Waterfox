...
protections-panel-content-blocking-breakage-report-view =
    .title = 反馈网站问题
protections-panel-content-blocking-breakage-report-view-description = 拦截某些跟踪器可能导致部分网站出现问题，反馈问题可以帮助改善所有用户的 { -brand-short-name } 使用体验。发送反馈将会向 BrowserWorks 发送网页的地址及浏览器的有关信息。<label data-l10n-name="learn-more">详细了解</label>
