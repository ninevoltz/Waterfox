...
protocolhandler-mailto-os-handler-notificationbox = 要始终使用 { -brand-short-name } 来打开发送邮件的链接吗？
protocolhandler-mailto-os-handler-yes-confirm = 已将 { -brand-short-name } 设为打开邮件链接的默认应用程序。
protocolhandler-mailto-os-handler-yes-button = 设为默认
protocolhandler-mailto-os-handler-no-button = 暂时不要
...
protocolhandler-mailto-handler-yes-button = 设为默认
protocolhandler-mailto-handler-no-button = 暂时不要
