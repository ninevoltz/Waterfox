...
rights-intro-point-1 = { -brand-short-name } 提供给您时依照的条款为 <a data-l10n-name="mozilla-public-license-link">BrowserWorks 公共许可证（MPL）</a>。这表示您可以使用、复制和向他人分发 { -brand-short-name }。我们也非常欢迎您按自己的需要修改 { -brand-short-name } 的源代码。BrowserWorks 公共许可证还授予您分发您自己修改过的软件版本的权利。
rights-intro-point-2 = 您没有获得 BrowserWorks 基金会或其他任何一方的商标权利或许可，这包括但不限于 Waterfox 的名称或标志。有关商标的其他信息在：<a data-l10n-name="mozilla-trademarks-link">这里</a>。
