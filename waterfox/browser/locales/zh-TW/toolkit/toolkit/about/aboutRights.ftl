...
rights-intro-point-1 = { -brand-short-name } 是依照 <a data-l10n-name="mozilla-public-license-link">BrowserWorks 公眾授權條款</a>中的條件所提供給您的。這表示您可以使用、複製，或散布 { -brand-short-name } 給其他人。歡迎您自行修改 { -brand-short-name } 的原始碼以滿足您的需求；BrowserWorks 公眾授權條款也同時賦予您散布修改版本的權利。
rights-intro-point-2 = 您並未被授權使用 BrowserWorks 基金會或任何相關部門的商標，包含但不限於 Waterfox 的名稱或圖示。您可以在<a data-l10n-name="mozilla-trademarks-link">這裡</a>找到更多關於商標的使用條款。
